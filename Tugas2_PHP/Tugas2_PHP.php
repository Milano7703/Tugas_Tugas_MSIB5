...
<body>
    ...
    <form method="POST" action="">
        ...
        <select name="pekerjaan" id="pekerjaan" required>
            <option value="pekerjaan1" <?php if ($pekerjaan === "pekerjaan1") echo "selected"; ?>>Pekerjaan 1</option>
            <option value="pekerjaan2" <?php if ($pekerjaan === "pekerjaan2") echo "selected"; ?>>Pekerjaan 2</option>
        ...
        <?php
        // Daftar hobi
        $hobbies = array("hobby1", "hobby2", "hobby3", "hobby4", "hobby5", "hobby6", "hobby7", "hobby8", "hobby9", "hobby10");
